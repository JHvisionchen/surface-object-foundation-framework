...
#include "../../JHvisionFoundation/processing.h"
...
void processing::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (processing::*_t)(const QImage & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&processing::newFrame)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject processing::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_processing.data,
...
// SIGNAL 0
void processing::newFrame(const QImage & _t1)
{
